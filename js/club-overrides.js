...
window.CLUB_OVERRIDES = {
  austin: {
    displayCity: "Austin, TX",
    cadence: "Last Sunday",
    time: "Sunday, 10:00am CDT",
    eventTime: "10:00 AM CDT",
    venue: "Jo's Coffee Downtown, 242 W 2nd St",
    hostDisplay: "Alyssa Gray (@alyssajgray)",
    specificDates: ["2026-04-26"],
    locationNote: "Austin is back",
    flyerURL: "assets/flyers/austin-apr-26-2026.png",
    featured: true,
    isNew: true,
  },
  "austin, tx": {
  ...
  "panama city": {
    displayCity: "Panama City, Panama",
    cadence: "Fourth Thursday",
    time: "Thursday, 6:00pm",
    eventTime: "6:00 PM",
    venue: "Les Mecs, Calle Uruguay",
    hostDisplay: "Carla Batista, Jacob Larrinaga & Daniela Jovane",
    locationNote: "Panama Chapter",
    isNight: true,
    featured: true,
    isNew: true,
  },
